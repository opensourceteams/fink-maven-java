package com.module.flink.example.dataset.wordcount.n_01_formElements;
...
public class Run1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlatMapOperator<String, Tuple2<String, Integer>> flatMapOperator = text.flatMap(new FlatMapFunction<String, Tuple2<String,Integer>>() {
            @Override
